...
//{
   ...
   //         scvm.Filename = @"\\BP1\public\JesseRichards\REAL_DATA\MultiConfig\3710Config2.csv";
   ...
   //         }
   //         Thread.Sleep(5000);
   //         scvm.PersistFilename = @"\\BP1\public\JesseRichards\REAL_DATA\MultiConfig\3710Config2V2.txt";
   ...
   //     [Test]
   //     public void getTwoConfigsData()
   //     {
   //         string site = "3710";
   //         string sitename = "Sherman County";
   //         int count =2;
   ...
   //             Assert.IsInstanceOf(typeof(SingleConfigViewModel), scvm);
   //             scvm.Filename = @"\\BP1\public\JesseRichards\REAL_DATA\MultiConfig\"  + site + "Config" + i + ".csv";
   //             scvm.LoadFileCommand.Execute(null);
   //             int j = 0;
   //             while (scvm.DownloadedData.Count == 0)
   //             {
   ...
   //             }
   //             Thread.Sleep(5000);
   //             scvm.PersistFilename = @"\\BP1\public\JesseRichards\REAL_DATA\MultiConfig\"  + site + "Config" + i + "V2.txt";
   //             scvm.LoadPersistedConfigCommand.Execute(null);
   ...
   //             "HourByWSLower.csv",
   //             "HourByWSUpper.csv",
   //             "MonthByHourAlpha.csv",
   //             "MonthByHourCount.csv",
   //             "MonthByHourLower.csv",
   //             "MonthByHourUpper.csv",
   //             "MonthByWDAlpha.csv",
   //             "MonthByWDCount.csv",
   //             "MonthByWDLower.csv",
   //             "MonthByWDUpper.csv",
   ...
   //             string getfile= @"\\BP1\public\JesseRichards\REAL_DATA\Shear Matrix Testing\" + file;
   ...
   //         List<string> testfiles = new List<string>
   //         {
   //             "3710Config1Answers.csv",
   //             "3710Config2Answers.csv",
   //             "Config2wConfig1AlphaAnswers.csv"
   //         };
   //         Console.WriteLine("Loading shear test grids...");
   //         foreach (string file in testfiles)
   //         {

   //             string getfile = @"\\BP1\public\JesseRichards\REAL_DATA\MultiConfig\" + file;
   //             DataRepository repository
   //                   = new DataRepository(getfile, DataSourceType.CSV);
   ...
   //         for (int i = 0; i <=multiconfigs.Count - 1; i++)
   //         {
   //             WindDirectionComposite wdcomp = new WindDirectionComposite(multiconfigs[i].ColumnCollection , multiconfigs[i].DownloadedData[0]);
   //             wdcomp.CalculateComposites();

   //             WindSpeedComposite wscomp = new WindSpeedComposite(multiconfigs[i].ColumnCollection, multiconfigs[i].DownloadedData[0]);
   ...
   //        AbstractMergeWS ws = mergeFactory.CreateMergedWS();
   //        int config = 1;
   //        DateTime DeriveDate = multiconfigs[config].ColumnCollection.DataSetStart;

   //        int DrvUpperwsidx = multiconfigs[config].ColumnCollection.UpperWSComp(DeriveDate);
   //        int DrvLowerwsidx = multiconfigs[config].ColumnCollection.LowerWSComp(DeriveDate);

   //        ISessionColumn DrvUpperws = multiconfigs[config].ColumnCollection[DrvUpperwsidx];
   //        ISessionColumn DrvLowerws = multiconfigs[config].ColumnCollection[DrvLowerwsidx];
           
   //        SortedDictionary<double, List<double>> param = new SortedDictionary<double, List<double>>()
   //        {
   //            {DrvLowerws.getConfigAtDate (DeriveDate ).Height , WindART.Utils.ExtractDataTableColumn<double>(DrvLowerwsidx ,multiconfigs[config].DownloadedData[0])},
   //            {DrvUpperws.getConfigAtDate (DeriveDate ).Height,WindART.Utils.ExtractDataTableColumn <double>(DrvUpperwsidx ,multiconfigs[config].DownloadedData[0])}
   //        };
   ...
   //        newWS.Add(derived.DeriveNewWS(multiconfigs[config].ColumnCollection, alphaCollection[0], result, multiconfigs[config].DownloadedData[0], 80.0));
   //        newWS.Add(derived.DeriveNewWS(multiconfigs[config].ColumnCollection, alphaCollection[0], result, multiconfigs[config].DownloadedData[0], 65.0));
   //        newWS.Add(derived.DeriveNewWS(multiconfigs[config].ColumnCollection, alphaCollection[0], result, multiconfigs[config].DownloadedData[0], 30.0));

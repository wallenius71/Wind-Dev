...
namespace TurbineDataUtility.Model
{
    public class Project:INotifyPropertyChanged 
    {
        ...
        public Project(string projname)
        {
            name = projname;
            tags = new List<Tag>();
            longname = Utils.GetLongName(name);
        }
        ...
        public bool OutputFile(string outputFileLocation, DateTime start, DateTime end )
        {
            ...
            string filename = outputFileLocation + @"\" + this.longname +  "_" + st + "_to_" + e + @".csv";
            
            if (File.Exists(filename) & filename.Contains ("Flat_Ridge_II"))  //we have to rig the naming here because fr2 and fr2 south have exactly the same tag structure 
                filename =outputFileLocation + @"\" + this.longname +  "_South_" + st + "_to_" + e +  @".csv";

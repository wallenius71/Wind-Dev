...
namespace WindART
{
    public class WindSpeedFrequencyMonthHourWorkSheet:AbstractExcelWorkSheet 
    {
            ...
            SessionColumnType sheartype)
        {
            ...
            _ef = ef;
            _monthgrid = new SummaryGrid(collection, data, sheartype,0,new MonthAxis(), SummaryType.Month,false);
            _hourgrid = new SummaryGrid(collection, data,sheartype,0, new HourAxis(), SummaryType.Hour,false);
            ...
            int shearidx)
        {
            ...
            _ef = ef;
            _monthgrid = new SummaryGrid(collection, data, sheartype,shearidx, new MonthAxis(), SummaryType.Month,false);
            _hourgrid = new SummaryGrid(collection, data, sheartype,shearidx, new HourAxis(), SummaryType.Hour,false);

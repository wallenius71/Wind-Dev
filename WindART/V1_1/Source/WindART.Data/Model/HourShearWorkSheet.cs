...
namespace WindART
{
   public class HourShearWorkSheet:AbstractExcelWorkSheet 
    {
        IGrid _upperAvgGrid;
        IGrid _lowerAvgGrid;
        IGrid _alphaGrid;
       ...
       public HourShearWorkSheet(ShearCalculationGridCollection  gridcollection,ExcelFile ef)
        ...
        {
            Console.WriteLine("Build worksheet called for Hour worksheet");
            ...
            ExcelWorksheet thisSheet = _ef.Worksheets.Add("1 by " + uppergrid.Count + " Shear Grids");
            int i;
            //upper ws avg grid 
